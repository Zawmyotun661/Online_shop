        ...
        <div class="row">
            ...
            <div class="col-md-6">
                    ...
                    <form action="{{url ('package') }}" method="POST">      
                        ...
                        value="{{  old('order_date')}}" id="order_date">
                    ...
                    <div class="form-group">
                        ...
                        value="{{  old('expected_delivery_date')}}" id="expected_delivery_date">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            value="{{ old('customer_name')}}" id="customer_name" required >
                        ...
                        <div class="form-group">
                            ...
                            value="{{ old('facebook_name')}}" id="facebook_name" required >
                ...
                <div class="form-group">
                    ...
                    value="{{  old('cost')}}" id="cost" required>
                ...
                <div class="form-group mb-4">    
                    ...
                    value="{{  old('delivery_fee')}}" id="delivery_fee" required>
