                ...
                <div class="card-header">
                    <div class="input-group" id="myDiv">
                        ...
                        <div style="padding-left: 10px;">
                            <button class="btn btn-success  px-2" id="search" 
                            style="width: 180px; padding:10px; border-radius:20px; background:linear-gradient(to right, rgb(31, 28, 44), rgb(146, 141, 171))">
            ...
            $.ajax({
                ...
                success:function(data) {
                  ...
                  '</div>'+
                    ...
                    ' <div class="card-body ">'+  
                   '<div class="mb-4">'+
                    '<h5>'+   '<label>Date </label>'+ ' '+ ':: '+item.order_date+'</h5>'+
                    
                    '<h5>'+    '<label> Customer Name </label>'+ ' '+ ':: ' +item.customer_name+'</h5>'+
                    '<h5>' +   '<label> Facebook Name </label>'+ ' '+ ':: '+item.facebook_name+'</h5>'+
                    '<h5>' +   '<label> Delivery Status </label>'+ ' '+ ':: '+item.delivery_status+'</h5>'+
